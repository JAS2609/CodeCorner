...
import { AnswerDoc, VoteDoc } from "@/types/appwrite";  // <-- imported VoteDoc here
...
const Answers = ({
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const data: AnswerDoc = await response.json();
        ...
        <div key={answer.$id} className="flex gap-4">
          <div className="flex shrink-0 flex-col items-center gap-4">
            <VoteButtons
              type="answer"
              id={answer.$id}
              upvotes={answer.upvotesDocuments as Models.DocumentList<VoteDoc>}
              downvotes={answer.downvotesDocuments as Models.DocumentList<VoteDoc>}
            />
          ...
          <div className="w-full overflow-auto">
            ...
            <Comments
              comments={answer.comments as Models.DocumentList<CommentDoc>}
              className="mt-4"
              type="answer"
              typeId={answer.$id}
            />
